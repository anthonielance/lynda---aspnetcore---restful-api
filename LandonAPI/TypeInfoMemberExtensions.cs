...
namespace LandonAPI
{
    public static class TypeInfoMemberExtensions
    {
        ...
        public static IEnumerable<TypeInfo> GetAllTestedTypes(this TypeInfo typeInfo)
        ...
        public static IEnumerable<T> GetAll<T>(this TypeInfo typeInfo, Func<TypeInfo, IEnumerable<T>> accessor)
        {
            while (typeInfo != null)
            {
