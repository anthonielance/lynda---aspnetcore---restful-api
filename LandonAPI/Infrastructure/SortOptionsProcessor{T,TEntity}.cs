...
namespace LandonAPI.Infrastructure
{
    public class SortOptionsProcessor<T, TEntity>
    {
        ...
        public SortOptionsProcessor(string[] orderBy) => _orderBy = orderBy;
        ...
        public IQueryable<TEntity> Apply(IQueryable<TEntity> query)
        {
            ...
            foreach (var term in terms)
            {
                ...
                var keySelectory = ExpressionHelper.GetLambda(typeof(TEntity), propertyInfo.PropertyType, obj, key);

                // query.OrderBy/ThenBy[Descending](x => x.Property)
                modifiedQuery = ExpressionHelper
                    .CallOrderByOrThenBy(modifiedQuery, useThenBy, term.Descending, propertyInfo.PropertyType, keySelectory);
